...
public class DreamcastDeviceDomainClassifierTests
{
    ...
    [InlineData(0xA071_0000u, MemoryAccessKind.Read, "aica")]
    ...
    [InlineData(0xA060_0004u, MemoryAccessKind.Read, "modem")]
    [InlineData(0xA301_00C0u, MemoryAccessKind.Read, "external")]
