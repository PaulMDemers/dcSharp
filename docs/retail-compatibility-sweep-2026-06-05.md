...
1. Trace the remaining dormant `scheduler-expired-list-head` literal user at `0x8C01B160` or the next wake/runnable producer; the live `0x8C01AAA8 -> 0x8C01633C` path is now decoded as a priority-bucket insertion and does not write `0x8C1365AC`.
