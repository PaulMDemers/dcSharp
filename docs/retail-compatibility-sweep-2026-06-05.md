...
1. Trace the real activation path that should bridge Sega Rally's `0x8CEEE448` priority bucket into `0x8C131AA4/AA8`, `0x8C131AAC..AAF`, `0x8C1319A0..AC`, or the selected queue at `0x8C131B40`; the controlled `+0x1C`/region/ring pokes expose later gates but perturb scheduler/module state and are not fixes.
