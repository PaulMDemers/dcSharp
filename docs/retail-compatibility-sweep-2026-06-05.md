...
1. Classify Sega Rally 2's WinCE scheduler timebase and wait-list fields around `0x8C131888`, `0x8C136540`, and `0x8C136664`, then trace which guest condition should clear the stable `current-wait-delta=7` loop before adding more fast-forwards.
