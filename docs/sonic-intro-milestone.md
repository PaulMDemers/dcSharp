...
- The latest 120M no-trace SA2 profile reaches `PC=0x8C15AFA6` with 47/47 GD-ROM reads and no TA writes. CPU fast-forward has risen to `118,046,707`; the `0x8C10F440` cache loop, `0x8C134F3E` record-hash scan, `0x8C134CAA-0x8C134CBE` byte-copy body, `0x8C0089F8-0x8C008A12` IP.BIN bit-dispatch body, most repeated zero-tail redispatches, `0x8C008AD2-0x8C008B08` IP.BIN draw-helper body, `0x8C008A16-0x8C008A4A` set-bit draw-prefix body, `0x8C008A4E-0x8C008A74` glyph-loop tail body, `0x8C008A40-0x8C008A4A` set-bit draw-call tail, the `0x8C008A4C` loop-tail trigger, `0x8C0098CE-0x8C00996A` quotient-helper body, `0x8C009A2A-0x8C009ADA` remainder-helper body, and the mode-`0xFF` `0x8C15B606-0x8C15B648` AICA slot-dispatch body are retired or reduced from the hot profile. The next profile-guided targets are remaining IP.BIN trigger PCs (`0x8C0089F6`, `0x8C008A14`) and the SA2 AICA/helper clusters around `0x8C15B918`, `0x8C15C4DC`, `0x8C15C57C`, and `0x8C15C622`.
