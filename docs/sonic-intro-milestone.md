...
- The latest 120M no-trace SA2 profile reaches `PC=0x8C15AFA6` with 47/47 GD-ROM reads and no TA writes. CPU fast-forward has risen to `116,603,547`; the `0x8C10F440` cache loop, `0x8C134F3E` record-hash scan, and `0x8C134CAA-0x8C134CBE` byte-copy body are retired from the hot profile. The next profile-guided targets are mostly IP.BIN set-bit/draw paths plus remaining helper trigger PCs such as `0x8C134CA8`, `0x8C15B918`, `0x8C15B92E`, and `0x8C15C57C`.
