...
- `dcsharp_pvr_sprite.elf`: writes a real-shaped 32-byte sprite header with payload words, exposes TA stream payload-slot diagnostics, shuts down, and reports `ProgramExit`.
