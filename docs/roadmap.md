...
- Inspect retail-adjacent media without booting it. Started: `media inspect` reports raw/CUE/GDI geometry, CUE track layout, and IP.BIN-style Dreamcast boot metadata when a readable boot sector is found.
