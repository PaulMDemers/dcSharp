...
int main(int argc, char **argv) {
    ...
    const uint32_t texture_base = 0x00009000u;
    const uint32_t mode2 = 0x00018009u;
    const uint32_t mode3 = 0x0c009000u;
    ...
    DCSHARP_PVR_VRAM16(texture_base + (((0u * 16u) + 0u) * 2u)) = 0xf800u;
    DCSHARP_PVR_VRAM16(texture_base + (((0u * 16u) + 15u) * 2u)) = 0x07e0u;
    DCSHARP_PVR_VRAM16(texture_base + (((15u * 16u) + 0u) * 2u)) = 0x001fu;
    ...
    printf("dcSharp PVR texture size probe: texture_base=0x%08lx mode2=0x%08lx mode3=0x%08lx ta_init=0x%08lx\n",
