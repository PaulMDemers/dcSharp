...
int main(int argc, char **argv) {
    ...
    write_pvr_vertex(0xe0000000u, 0x3f800000u, 0x3f800000u, 0xff0000ffu);
    write_pvr_vertex(0xe0000000u, 0x40000000u, 0x3f800000u, 0xff0000ffu);
    write_pvr_vertex(0xf0000000u, 0x3f800000u, 0x40000000u, 0xff0000ffu);

    printf("dcSharp PVR real modes probe: header=0x%08lx mode1=0x%08lx mode2=0x%08lx mode3=0x%08lx ta_init=0x%08lx\n",
