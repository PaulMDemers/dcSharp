...
int main(int argc, char **argv) {
    ...
    const uint32_t texture_base = 0x00004000u;
    ...
    DCSHARP_PVR_VRAM16(texture_base + 0u) = 0xff00u;
    DCSHARP_PVR_VRAM16(texture_base + 14u) = 0xf0f0u;
    DCSHARP_PVR_VRAM16(texture_base + (7u * 8u * 2u)) = 0xf00fu;
    ...
    printf("dcSharp PVR texture ARGB4444 probe: texture_base=0x%08lx mode3=0x%08lx ta_init=0x%08lx\n",
