...
static void write_triangle(uint32_t mode1, uint32_t argb) {
...
int main(int argc, char **argv) {
    ...
    const uint32_t ccw_mode1 = 0x10000000u;
    const uint32_t cw_mode1 = 0x18000000u;
    ...
    write_triangle(ccw_mode1, 0xff00ff00u);
    write_triangle(cw_mode1, 0xffff0000u);

    printf("dcSharp PVR culling probe: ccw_mode1=0x%08lx cw_mode1=0x%08lx ta_init=0x%08lx\n",
           (unsigned long)ccw_mode1,
           (unsigned long)cw_mode1,
