...
int main(int argc, char **argv) {
    ...
    DCSHARP_PVR_VRAM16(texture_base + (((7u * 8u) + 7u) * 2u)) = 0x001fu;

    write_words(header, 8);
    write_words(vertices, 16);

    printf("dcSharp PVR sprite texture RGB565 probe: texture_base=0x%08lx mode3=0x%08lx auv=0x%08lx cuv=0x%08lx ta_init=0x%08lx\n",
