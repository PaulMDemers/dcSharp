...
int main(int argc, char **argv) {
    ...
    const uint32_t texture_base = 0x0000c000u;
    const uint32_t mode1 = 0x02000000u;
    const uint32_t mode2 = 0x00018040u;
    const uint32_t mode3 = 0x0c00c000u;
    ...
    printf("dcSharp PVR sprite texture shading probe: texture_base=0x%08lx mode2=0x%08lx mode3=0x%08lx auv=0x%08lx cuv=0x%08lx ta_init=0x%08lx\n",
