...
int main(int argc, char **argv) {
    ...
    const uint32_t texture_base = 0x00007000u;
    const uint32_t mode2 = 0x00018040u;
    const uint32_t mode3 = 0x0c007000u;
    ...
    DCSHARP_PVR_VRAM16(texture_base + 0u) = 0xffffu;
    DCSHARP_PVR_VRAM16(texture_base + 14u) = 0xffffu;
    DCSHARP_PVR_VRAM16(texture_base + (7u * 8u * 2u)) = 0xffffu;

    write_words(header, 8);
    write_pvr_vertex(0xe0000000u, 0x3f800000u, 0x3f800000u, 0x00000000u, 0x00000000u, 0xff00ff00u);
    write_pvr_vertex(0xe0000000u, 0x40000000u, 0x3f800000u, 0x3f800000u, 0x00000000u, 0xff00ff00u);
    write_pvr_vertex(0xf0000000u, 0x3f800000u, 0x40000000u, 0x00000000u, 0x3f800000u, 0xff00ff00u);

    printf("dcSharp PVR texture shading probe: texture_base=0x%08lx mode2=0x%08lx mode3=0x%08lx ta_init=0x%08lx\n",
