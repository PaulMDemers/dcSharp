...
static void write_triangle(uint32_t mode2, uint32_t argb) {
    ...
    write_words(vertex0, 8);
    write_words(vertex1, 8);
    write_words(vertex2, 8);
}
...
int main(int argc, char **argv) {
    ...
    write_triangle(opaque_mode2, 0xff00ff00u);
    write_triangle(blend_mode2, 0x80ff0000u);

    printf("dcSharp PVR blend probe: opaque_mode2=0x%08lx blend_mode2=0x%08lx ta_init=0x%08lx\n",
           (unsigned long)opaque_mode2,
