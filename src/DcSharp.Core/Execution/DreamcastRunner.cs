        ...
        try
        {
            while (cpu.State.InstructionsExecuted < options.InstructionLimit)
            {
                        ...
                        out var sonicAdventure2ByteFillSkippedInstructions))
                {
                    ...
                    && options.MemoryWriteWatch is null
                    && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C11_0554, 0x8C11_0582)
                    && cpu.TryFastForwardSonicAdventure2AlignedWordZeroFillLoop(
                        step,
                        options.InstructionLimit - cpu.State.InstructionsExecuted,
                        out var sonicAdventure2AlignedWordZeroFillSkippedInstructions))
                {
                    scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AlignedWordZeroFillSkippedInstructions, cpu.State.InstructionsExecuted);
                }
                else if (options.MemoryReadWatch is null
                    && options.MemoryWriteWatch is null
                    && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B478, 0x8C16_B4C4)
                    && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C0C_1098, 0x8C0C_111C)
                    && cpu.TryFastForwardSonicAdventure2AicaWorkQueueCopyTableLoop(
                        step,
                        options.InstructionLimit - cpu.State.InstructionsExecuted,
                        out var sonicAdventure2AicaWorkQueueCopyTableLoopSkippedInstructions))
                {
                    scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueCopyTableLoopSkippedInstructions, cpu.State.InstructionsExecuted);
                }
                else if (options.MemoryReadWatch is null
                    && options.MemoryWriteWatch is null
                    && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C0C_1098, 0x8C0C_111C)
                    && cpu.TryFastForwardSonicAdventure2SmallWordCopyTableHelper(
                        step,
                        options.InstructionLimit - cpu.State.InstructionsExecuted,
                        out var sonicAdventure2SmallWordCopyTableSkippedInstructions))
                {
                    scheduler.AdvanceAfterCpuFastForward(sonicAdventure2SmallWordCopyTableSkippedInstructions, cpu.State.InstructionsExecuted);
                }
                else if (options.MemoryReadWatch is null
                    && options.MemoryWriteWatch is null
                    && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C9D0, 0x8C15_C9DC)
                    && cpu.TryFastForwardSonicAdventure2AicaDescriptorNameSpaceFillLoop(
                        step,
                        options.InstructionLimit - cpu.State.InstructionsExecuted,
                        out var sonicAdventure2AicaDescriptorNameSpaceFillSkippedInstructions))
                {
                    scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaDescriptorNameSpaceFillSkippedInstructions, cpu.State.InstructionsExecuted);
                }
                else if (options.MemoryReadWatch is null
                    && options.MemoryWriteWatch is null
                    && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C10_FC70, 0x8C10_FC78)
                    && cpu.TryFastForwardSonicAdventure2InterruptMaskTableClearLoop(
                        step,
                        options.InstructionLimit - cpu.State.InstructionsExecuted,
                        out var sonicAdventure2InterruptMaskTableClearSkippedInstructions))
                {
                    scheduler.AdvanceAfterCpuFastForward(sonicAdventure2InterruptMaskTableClearSkippedInstructions, cpu.State.InstructionsExecuted);
                }
                else if (options.MemoryReadWatch is null
                    && options.MemoryWriteWatch is null
                    && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C10_FC80, 0x8C10_FC88)
                    && cpu.TryFastForwardSonicAdventure2InterruptPendingTableClearLoop(
                        step,
                        options.InstructionLimit - cpu.State.InstructionsExecuted,
                        out var sonicAdventure2InterruptPendingTableClearSkippedInstructions))
                {
                    scheduler.AdvanceAfterCpuFastForward(sonicAdventure2InterruptPendingTableClearSkippedInstructions, cpu.State.InstructionsExecuted);
                }
                else if (options.MemoryReadWatch is null
                    && options.MemoryWriteWatch is null
                    ...
                    && cpu.TryFastForwardSonicAdventure2RecordHashScan(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2RecordHashScanSkippedInstructions))
                {
                    ...
                    && options.MemoryWriteWatch is null
                    && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C12_BF50, 0x8C12_BF54)
                    && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C12_CB98, 0x8C12_CBC0)
                    && cpu.TryFastForwardSonicAdventure2ModifierVolumeCallbackPollLoop(
                        step,
                        scheduler.ClampFastForwardToExternalWake(options.InstructionLimit - cpu.State.InstructionsExecuted),
                        out var sonicAdventure2ModifierVolumeCallbackPollSkippedInstructions))
                {
                    scheduler.AdvanceAfterCpuFastForward(sonicAdventure2ModifierVolumeCallbackPollSkippedInstructions, cpu.State.InstructionsExecuted);
                }
                else if (options.MemoryReadWatch is null
                    && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C0A_49D8, 0x8C0A_4A0E)
                    && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C0A_4AFA, 0x8C0A_4B70)
                    && cpu.TryFastForwardSonicAdventure2BitUnpackRows(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2BitUnpackRowsSkippedInstructions))
                {
                    scheduler.AdvanceAfterCpuFastForward(sonicAdventure2BitUnpackRowsSkippedInstructions, cpu.State.InstructionsExecuted);
                }
                else if (options.MemoryReadWatch is null
                    && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C0A_49D8, 0x8C0A_4A0E)
                    && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C0A_4AFA, 0x8C0A_4B70)
                    && cpu.TryFastForwardSonicAdventure2BitUnpackRowSetup(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2BitUnpackRowSetupSkippedInstructions))
                {
                    scheduler.AdvanceAfterCpuFastForward(sonicAdventure2BitUnpackRowSetupSkippedInstructions, cpu.State.InstructionsExecuted);
                }
                else if (options.MemoryReadWatch is null
                    && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C0A_49D8, 0x8C0A_4A0E)
                    && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C0A_4B14, 0x8C0A_4B4A)
                    && cpu.TryFastForwardSonicAdventure2BitUnpackByteTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2BitUnpackSkippedInstructions))
                {
                    scheduler.AdvanceAfterCpuFastForward(sonicAdventure2BitUnpackSkippedInstructions, cpu.State.InstructionsExecuted);
                }
                else if (options.MemoryReadWatch is null
                    && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C0A_49D8, 0x8C0A_4A0E)
                    && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C0A_4B14, 0x8C0A_4B4A)
                    && cpu.TryFastForwardSonicAdventure2BitUnpackByteBody(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2BitUnpackBodySkippedInstructions))
                {
                    scheduler.AdvanceAfterCpuFastForward(sonicAdventure2BitUnpackBodySkippedInstructions, cpu.State.InstructionsExecuted);
                }
                else if (options.MemoryReadWatch is null
                    && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C0A_49D8, 0x8C0A_4A0E)
                    && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C0A_4B14, 0x8C0A_4B70)
                    && cpu.TryFastForwardSonicAdventure2BitUnpackByteStore(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2BitUnpackByteStoreSkippedInstructions))
                {
                    scheduler.AdvanceAfterCpuFastForward(sonicAdventure2BitUnpackByteStoreSkippedInstructions, cpu.State.InstructionsExecuted);
                }
                else if (options.MemoryReadWatch is null
                    && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C0A_4A6A, 0x8C0A_4AA8)
                    && cpu.TryFastForwardSonicAdventure2ForwardByteMaskGroupScan(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2ForwardByteMaskGroupSkippedInstructions))
                {
                    scheduler.AdvanceAfterCpuFastForward(sonicAdventure2ForwardByteMaskGroupSkippedInstructions, cpu.State.InstructionsExecuted);
                }
                else if (options.MemoryReadWatch is null
                    && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C0A_4AB8, 0x8C0A_4AF6)
                    && cpu.TryFastForwardSonicAdventure2ByteMaskGroupScan(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2ByteMaskGroupSkippedInstructions))
                {
                    scheduler.AdvanceAfterCpuFastForward(sonicAdventure2ByteMaskGroupSkippedInstructions, cpu.State.InstructionsExecuted);
                }
                else if (options.MemoryReadWatch is null
                    && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C0A_4AB8, 0x8C0A_4AF6)
                    && cpu.TryFastForwardSonicAdventure2ZeroByteMaskGroupScan(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2ZeroByteMaskGroupSkippedInstructions))
                {
                    scheduler.AdvanceAfterCpuFastForward(sonicAdventure2ZeroByteMaskGroupSkippedInstructions, cpu.State.InstructionsExecuted);
                }
                else if (options.MemoryReadWatch is null
                    && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C0A_4ADA, 0x8C0A_4AEA)
                    && cpu.TryFastForwardSonicAdventure2NonzeroByteMaskWalk(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2NonzeroByteMaskWalkSkippedInstructions))
                {
                    scheduler.AdvanceAfterCpuFastForward(sonicAdventure2NonzeroByteMaskWalkSkippedInstructions, cpu.State.InstructionsExecuted);
                }
                ...
                else
                {
                            ...
                            out var ipBinAsicEventWaitSkippedInstructions))
                    {
                        ...
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C00_86A8, 0x8C00_86E0)
                        && cpu.TryFastForwardIpBinGlyphTableScanLoop(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var ipBinGlyphTableScanSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(ipBinGlyphTableScanSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C00_8A76, 0x8C00_8A8A)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C00_89DC, 0x8C00_8A76)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C00_8A14, 0x8C00_8A4C)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C00_98CC, 0x8C00_996C)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C00_9A28, 0x8C00_9ADC)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C00_8AD0, 0x8C00_8B0A)
                        && cpu.TryFastForwardIpBinGlyphByteExitTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var ipBinGlyphByteExitSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(ipBinGlyphByteExitSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C00_89DC, 0x8C00_8A76)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C00_9A28, 0x8C00_9ADC)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C00_8AD0, 0x8C00_8B0A)
                        && cpu.TryFastForwardIpBinGlyphByteFetchPrefix(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var ipBinGlyphByteFetchSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(ipBinGlyphByteFetchSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C00_89F6, 0x8C00_8A14)
                        && cpu.TryFastForwardIpBinGlyphBitDispatch(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var ipBinGlyphBitDispatchSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(ipBinGlyphBitDispatchSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        ...
                        && cpu.TryFastForwardIpBinZeroBitGlyphLoop(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var ipBinZeroBitGlyphSkippedInstructions))
                    {
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C00_9A28, 0x8C00_9ADC)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C00_8AD0, 0x8C00_8B0A)
                        && cpu.TryFastForwardIpBinSetBitGlyphDrawPrefix(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var ipBinSetBitGlyphDrawPrefixSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(ipBinSetBitGlyphDrawPrefixSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                    ...
                    {
                        scheduler.AdvanceAfterCpuFastForward(ipBinSignedDivideQuotientSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C00_9A28, 0x8C00_9ADC)
                        && cpu.TryFastForwardIpBinSignedDivideRemainderHelper(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var ipBinSignedDivideRemainderSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(ipBinSignedDivideRemainderSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C00_8A3E, 0x8C00_8A4C)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C00_8AD0, 0x8C00_8B0A)
                        && cpu.TryFastForwardIpBinSetBitGlyphDrawTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var ipBinSetBitGlyphDrawTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(ipBinSetBitGlyphDrawTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C00_8AD0, 0x8C00_8B0A)
                        && cpu.TryFastForwardIpBinGlyphDrawHelper(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var ipBinGlyphDrawSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(ipBinGlyphDrawSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        ...
                        && cpu.TryFastForwardSonicAdventure2PrsDecompressor(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2PrsSkippedInstructions))
                    {
                        ...
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C10_04E0, 0x8C10_04F6)
                        && cpu.TryFastForwardSonicAdventure2BootWorkSegaFillLoop(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2BootWorkSegaFillSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2BootWorkSegaFillSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        ...
                        && cpu.TryFastForwardSonicAdventure2SystemRamByteClearLoop(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2SystemRamByteClearSkippedInstructions))
                    {
                        ...
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_7DF0, 0x8C16_7E02)
                        && cpu.TryFastForwardSonicAdventure2SparseWordClearLoop(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2SparseWordClearSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2SparseWordClearSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        ...
                        && cpu.TryFastForwardSonicAdventure2AicaByteReadHelperLimitLoadToActiveBytePoll(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaByteReadLimitLoadToActiveBytePollSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaByteReadLimitLoadToActiveBytePollSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_BF10, 0x8C16_BF44)
                        ...
                        && cpu.TryFastForwardSonicAdventure2AicaByteReadHelper(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaByteReadSkippedInstructions))
                    {
                        ...
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_57E2, 0x8C13_5806)
                        && cpu.TryFastForwardSonicAdventure2G2PioReadWordCopyLoop(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2PioReadWordCopySkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2PioReadWordCopySkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        ...
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueNoWorkPoll(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaWorkQueueSkippedInstructions))
                    {
                        ...
                        && cpu.TryFastForwardSonicAdventure2AicaEmptyWorkTableScanSetupTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaEmptyWorkTableScanSetupTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaEmptyWorkTableScanSetupTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_C6F8, 0x8C16_C858)
                        && cpu.TryFastForwardSonicAdventure2AicaEmptyWorkTableScan(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaEmptyWorkTableScanSkippedInstructions))
                    {
                        ...
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_C3B8, 0x8C16_C3D0)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_C65E, 0x8C16_C67E)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkEntryStatusScan(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaWorkEntryStatusScanSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkEntryStatusScanSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_C3B8, 0x8C16_C3D0)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_C65E, 0x8C16_C67E)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkEntryStatusScanTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaWorkEntryStatusScanTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkEntryStatusScanTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_C1A4, 0x8C16_C35E)
                        && cpu.TryFastForwardSonicAdventure2AicaActiveWorkFieldEmptyScan(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaActiveWorkFieldEmptyScanSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaActiveWorkFieldEmptyScanSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_61C2, 0x8C13_61EC)
                        && cpu.TryFastForwardSonicAdventure2AicaServiceHelperPostStatusMirrorUpdate(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaServiceHelperPostStatusMirrorUpdateSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaServiceHelperPostStatusMirrorUpdateSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_61EC, 0x8C13_61F0)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_5DDC, 0x8C13_5E1E)
                        && cpu.TryFastForwardSonicAdventure2AicaMirrorCopyCallFromInactiveService(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaMirrorCopyCallFromInactiveServiceSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaMirrorCopyCallFromInactiveServiceSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_61F2, 0x8C13_622E)
                        && cpu.TryFastForwardSonicAdventure2AicaServiceHelperFinalCounterTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaServiceHelperFinalCounterTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaServiceHelperFinalCounterTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_5DDC, 0x8C13_5E1E)
                        && cpu.TryFastForwardSonicAdventure2AicaMirrorCopyFunction(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaMirrorCopyFunctionSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaMirrorCopyFunctionSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_5DDC, 0x8C13_5E1E)
                        && cpu.TryFastForwardSonicAdventure2AicaMirrorCopyLoop(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaMirrorCopySkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaMirrorCopySkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C10_FF2E, 0x8C10_FF4C)
                        && cpu.TryFastForwardSonicAdventure2InterruptSourceEmptyScanTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2InterruptSourceScanSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2InterruptSourceScanSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        ...
                        && cpu.TryFastForwardSonicAdventure2StringHashLoop(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2StringHashSkippedInstructions))
                    {
                        ...
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_4CA8, 0x8C13_4CC0)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_4D8E, 0x8C13_4EE2)
                        && cpu.TryFastForwardSonicAdventure2RecordNameWalkLoopTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2RecordNameWalkLoopTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2RecordNameWalkLoopTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_4CA8, 0x8C13_4CC0)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_4D8E, 0x8C13_4E4A)
                        && cpu.TryFastForwardSonicAdventure2RecordNameParseEntryTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2RecordNameParseEntryTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2RecordNameParseEntryTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_4CA8, 0x8C13_4CC0)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_4D8E, 0x8C13_4E4A)
                        && cpu.TryFastForwardSonicAdventure2RecordNameParse(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2RecordNameParseSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2RecordNameParseSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_5DDC, 0x8C13_5E1E)
                        ...
                        && cpu.TryFastForwardSonicAdventure2EmptyPointerTableScan(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2EmptyPointerTableScanSkippedInstructions))
                    {
                        ...
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_5D40, 0x8C13_5DB0)
                        && cpu.TryFastForwardSonicAdventure2AicaInactiveCallbackHelperReturn(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaInactiveCallbackHelperReturnSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaInactiveCallbackHelperReturnSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_5C72, 0x8C13_5CA0)
                        && cpu.TryFastForwardSonicAdventure2AicaCounterCallbackReturnTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaCounterCallbackReturnTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaCounterCallbackReturnTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_5CA2, 0x8C13_5CBC)
                        && cpu.TryFastForwardSonicAdventure2AicaCallbackMaskedPrologue(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaCallbackMaskedPrologueSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaCallbackMaskedPrologueSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_5CBE, 0x8C13_5CC8)
                        && cpu.TryFastForwardSonicAdventure2AicaCallbackCounterIncrementCall(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaCallbackCounterIncrementCallSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaCallbackCounterIncrementCallSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_62FE, 0x8C13_632E)
                        && cpu.TryFastForwardSonicAdventure2AicaCallbackServicePrologue(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaCallbackServicePrologueSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaCallbackServicePrologueSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_6044, 0x8C13_6070)
                        && cpu.TryFastForwardSonicAdventure2AicaServiceHelperFlaggedPrologue(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaServiceHelperFlaggedPrologueSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaServiceHelperFlaggedPrologueSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_6072, 0x8C13_609C)
                        && cpu.TryFastForwardSonicAdventure2AicaServiceHelperFirstResetBlock(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaServiceHelperFirstResetBlockSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaServiceHelperFirstResetBlockSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        ...
                        && cpu.TryFastForwardSonicAdventure2AicaServiceHelperSecondResetBlock(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaServiceHelperSecondResetBlockSkippedInstructions))
                    {
                        ...
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_60BC, 0x8C13_61BA)
                        && cpu.TryFastForwardSonicAdventure2AicaServiceHelperStatusBranch(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaServiceHelperStatusBranchSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaServiceHelperStatusBranchSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                    ...
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaAsicAckCallbackSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        ...
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueActiveBytePollAfterR11Push(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaWorkQueueActiveBytePollAfterR11PushSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueActiveBytePollAfterR11PushSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B4CC, 0x8C16_B5D8)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_43A0, 0x8C15_43EE)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_500C, 0x8C15_5038)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueActiveBytePollPrologue(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaWorkQueueActiveBytePollPrologueSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueActiveBytePollPrologueSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B4CC, 0x8C16_B5D8)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_43A0, 0x8C15_43EE)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_500C, 0x8C15_5038)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueActiveBytePollInterruptMaskStore(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaWorkQueueActiveBytePollInterruptMaskStoreSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueActiveBytePollInterruptMaskStoreSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B4F0, 0x8C16_B5D8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_BF10, 0x8C16_BF48)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_43A0, 0x8C15_43EE)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_500C, 0x8C15_5038)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueActiveBytePollSrMaskTail(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaWorkQueueActiveBytePollSrMaskTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueActiveBytePollSrMaskTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B4CC, 0x8C16_B5D8)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_43A0, 0x8C15_43EE)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_500C, 0x8C15_5038)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueActiveBytePollSrLoad(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaWorkQueueActiveBytePollSrLoadSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueActiveBytePollSrLoadSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B4CC, 0x8C16_B5D8)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_43A0, 0x8C15_43EE)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_500C, 0x8C15_5038)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueActiveBytePollWorkGlobalTest(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaWorkQueueActiveBytePollWorkGlobalTestSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueActiveBytePollWorkGlobalTestSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B4CC, 0x8C16_B5D8)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_43A0, 0x8C15_43EE)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_500C, 0x8C15_5038)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueActiveBytePollActiveCallbackLoadTail(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaWorkQueueActiveBytePollActiveCallbackLoadTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueActiveBytePollActiveCallbackLoadTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B51A, 0x8C16_B5D8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_BF10, 0x8C16_BF48)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_43A0, 0x8C15_43EE)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_500C, 0x8C15_5038)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueActiveBytePollCallDelaySlot(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaWorkQueueActiveBytePollCallDelaySlotSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueActiveBytePollCallDelaySlotSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B4CC, 0x8C16_B5D8)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_43A0, 0x8C15_43EE)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_500C, 0x8C15_5038)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueActiveBytePollMidPrologue(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaWorkQueueActiveBytePollMidPrologueSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueActiveBytePollMidPrologueSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B4CC, 0x8C16_B5D8)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_43A0, 0x8C15_43EE)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_500C, 0x8C15_5038)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueActiveBytePollAfterByteReadReturn(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaWorkQueueActiveBytePollAfterByteReadReturnSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueActiveBytePollAfterByteReadReturnSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B4CC, 0x8C16_B5D8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_BF40, 0x8C16_BF48)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_500C, 0x8C15_5038)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueActiveBytePollAfterPrRestore(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaWorkQueueActiveBytePollAfterPrRestoreSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueActiveBytePollAfterPrRestoreSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B4CC, 0x8C16_B5D8)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_43A0, 0x8C15_43EE)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_500C, 0x8C15_5038)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueActiveBytePollAfterReadWrapperReturn(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaWorkQueueActiveBytePollAfterReadWrapperReturnSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueActiveBytePollAfterReadWrapperReturnSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B4CC, 0x8C16_B5D8)
                            ...
                            out var sonicAdventure2AicaWorkQueueActiveBytePollAfterByteAddressAddSkippedInstructions))
                    {
                        ...
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueActiveBytePollAfterByteStore(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaWorkQueueActiveBytePollAfterByteStoreSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueActiveBytePollAfterByteStoreSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B4CC, 0x8C16_B5D8)
                            ...
                            out var sonicAdventure2AicaWorkQueueActiveByteSkippedInstructions))
                    {
                        ...
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_500C, 0x8C15_5038)
                        && cpu.TryFastForwardSonicAdventure2AicaActiveWorkCallbackNoPendingTargetStoreTail(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaActiveWorkCallbackNoPendingTargetStoreTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaActiveWorkCallbackNoPendingTargetStoreTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_500C, 0x8C15_5038)
                        && cpu.TryFastForwardSonicAdventure2AicaActiveWorkCallbackNoPendingStoreTail(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaActiveWorkCallbackNoPendingStoreTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaActiveWorkCallbackNoPendingStoreTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_500C, 0x8C15_5038)
                        && cpu.TryFastForwardSonicAdventure2AicaActiveWorkCallbackNoPendingTail(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaActiveWorkCallbackNoPendingTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaActiveWorkCallbackNoPendingTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B586, 0x8C16_B5D8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_500C, 0x8C15_5038)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueActiveCallbackStatusLoadTail(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaWorkQueueActiveCallbackStatusLoadTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueActiveCallbackStatusLoadTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B588, 0x8C16_B5D8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_500C, 0x8C15_5038)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueActiveCallbackStatusRestoreTail(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaWorkQueueActiveCallbackStatusRestoreTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueActiveCallbackStatusRestoreTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B58C, 0x8C16_B5D8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_500C, 0x8C15_5038)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueActiveCallbackStatusMaskTail(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaWorkQueueActiveCallbackStatusMaskTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueActiveCallbackStatusMaskTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B594, 0x8C16_B5D8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_500C, 0x8C15_5038)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueActiveCallbackStatusCommitTail(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaWorkQueueActiveCallbackStatusCommitTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueActiveCallbackStatusCommitTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B58A, 0x8C16_B5D8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_500C, 0x8C15_5038)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueActiveCallbackTail(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaWorkQueueActiveCallbackTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueActiveCallbackTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B59E, 0x8C16_B5D8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_500C, 0x8C15_5038)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueActiveCallbackLiteralTail(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaWorkQueueActiveCallbackLiteralTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueActiveCallbackLiteralTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B5A0, 0x8C16_B5D8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_500C, 0x8C15_5038)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueActiveCallbackCallDelaySlot(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaWorkQueueActiveCallbackCallDelaySlotSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueActiveCallbackCallDelaySlotSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B5A4, 0x8C16_B5D8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_500C, 0x8C15_5038)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueActiveCallbackReturnTail(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaWorkQueueActiveCallbackReturnTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueActiveCallbackReturnTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B5B2, 0x8C16_B5B8)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueActiveCallbackRestoreTail(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaWorkQueueActiveCallbackRestoreTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueActiveCallbackRestoreTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B5B6, 0x8C16_B5B8)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkQueueActiveCallbackReturnDelaySlot(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2AicaWorkQueueActiveCallbackReturnDelaySlotSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkQueueActiveCallbackReturnDelaySlotSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B5B6, 0x8C15_B690)
                        && cpu.TryFastForwardSonicAdventure2AicaNoWorkSetupTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaNoWorkSetupTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaNoWorkSetupTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B604, 0x8C15_B692)
                        && cpu.TryFastForwardSonicAdventure2AicaNoWorkSlotScanEntryRun(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaNoWorkSlotScanEntryRunSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaNoWorkSlotScanEntryRunSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B604, 0x8C15_B692)
                        && cpu.TryFastForwardSonicAdventure2AicaNoWorkSlotScanEntry(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaNoWorkSlotScanEntrySkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaNoWorkSlotScanEntrySkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B604, 0x8C15_B692)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_CA7A, 0x8C15_CA8E)
                        ...
                        && cpu.TryFastForwardSonicAdventure2AicaActiveSlotModeOneDescriptorUpdateThroughLoopTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaActiveSlotModeOneDescriptorUpdateThroughLoopTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaActiveSlotModeOneDescriptorUpdateThroughLoopTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C0E2, 0x8C15_C11E)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C126, 0x8C15_C142)
                        && cpu.TryFastForwardSonicAdventure2AicaActiveSlotModeOneDescriptorUpdate(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaActiveSlotModeOneDescriptorUpdateSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaActiveSlotModeOneDescriptorUpdateSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B604, 0x8C15_B686)
                    ...
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaActiveSlotModeDispatchSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_BF20, 0x8C15_BF72)
                        && cpu.TryFastForwardSonicAdventure2AicaDescriptorSetupTailToPointerAdvance(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaDescriptorSetupTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaDescriptorSetupTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_BF22, 0x8C15_BF72)
                        && cpu.TryFastForwardSonicAdventure2AicaDescriptorSetupLiteralTailToPointerAdvance(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaDescriptorSetupLiteralTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaDescriptorSetupLiteralTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B604, 0x8C15_B692)
                        && cpu.TryFastForwardSonicAdventure2AicaNoWorkSlotScanLoopTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaNoWorkSlotScanLoopTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaNoWorkSlotScanLoopTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B604, 0x8C15_B692)
                        && cpu.TryFastForwardSonicAdventure2AicaNoWorkSlotScan(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaNoWorkSlotScanSkippedInstructions))
                    {
                        ...
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B8EE, 0x8C15_B918)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C416, 0x8C15_C4C6)
                        ...
                        && cpu.TryFastForwardSonicAdventure2AicaNameGroupDescriptorHeadNextZeroMaskSetupAggregate(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaNameGroupDescriptorHeadNextZeroMaskSetupAggregateSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaNameGroupDescriptorHeadNextZeroMaskSetupAggregateSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B8EE, 0x8C15_B918)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C57C, 0x8C15_C5D8)
                        && cpu.TryFastForwardSonicAdventure2AicaNameGroupDescriptorHeadNextActiveSetupAggregate(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaNameGroupDescriptorHeadNextActiveSetupAggregateSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaNameGroupDescriptorHeadNextActiveSetupAggregateSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B8EE, 0x8C15_B918)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C416, 0x8C15_C4C6)
                        && cpu.TryFastForwardSonicAdventure2AicaNameGroupDescriptorHeadAggregate(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaNameGroupDescriptorHeadAggregateSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaNameGroupDescriptorHeadAggregateSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B93A, 0x8C15_B940)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B8EC, 0x8C15_B918)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C416, 0x8C15_C4C6)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B918, 0x8C15_B92E)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C4DC, 0x8C15_C564)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C572, 0x8C15_C57C)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C680, 0x8C15_C69C)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C57C, 0x8C15_C5D8)
                        && cpu.TryFastForwardSonicAdventure2AicaNameGroupTailNextZeroMaskSetupAggregate(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaNameGroupTailNextZeroMaskSetupAggregateSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaNameGroupTailNextZeroMaskSetupAggregateSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B93A, 0x8C15_B940)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C56E, 0x8C15_C570)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C57C, 0x8C15_C5D8)
                        && cpu.TryFastForwardSonicAdventure2AicaNameGroupTailNextActiveSetupAggregate(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaNameGroupTailNextActiveSetupAggregateSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaNameGroupTailNextActiveSetupAggregateSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B93A, 0x8C15_B940)
                        && cpu.TryFastForwardSonicAdventure2AicaNameGroupTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaNameGroupTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaNameGroupTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C680, 0x8C15_C69C)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C57C, 0x8C15_C5D8)
                        && cpu.TryFastForwardSonicAdventure2AicaNameCallZeroMaskSetupAggregate(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaNameCallZeroMaskSetupAggregateSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaNameCallZeroMaskSetupAggregateSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B91A, 0x8C15_B92E)
                        ...
                        && cpu.TryFastForwardSonicAdventure2AicaChannelSetupBridge(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaChannelSetupSkippedInstructions))
                    {
                        ...
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C4DE, 0x8C15_C564)
                        && cpu.TryFastForwardSonicAdventure2AicaChannelSetupBridgeEntryTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaChannelSetupEntryTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaChannelSetupEntryTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C526, 0x8C15_C564)
                        && cpu.TryFastForwardSonicAdventure2AicaChannelSetupBridgeCallbackTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaChannelSetupCallbackTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaChannelSetupCallbackTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C512, 0x8C15_C564)
                        && cpu.TryFastForwardSonicAdventure2AicaChannelSetupBridgePreCallbackTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaChannelSetupPreCallbackTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaChannelSetupPreCallbackTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C55C, 0x8C15_C564)
                        && cpu.TryFastForwardSonicAdventure2AicaChannelSetupBridgeMaskTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaChannelSetupMaskTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaChannelSetupMaskTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C566, 0x8C15_C724)
                        ...
                        && cpu.TryFastForwardSonicAdventure2AicaActiveChannelDescriptorReturnAggregate(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaActiveChannelDescriptorReturnAggregateSkippedInstructions))
                    {
                        ...
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C566, 0x8C15_C724)
                        && cpu.TryFastForwardSonicAdventure2AicaChannelSetupActiveBridge(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaChannelSetupActiveSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaChannelSetupActiveSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C566, 0x8C15_C724)
                        && cpu.TryFastForwardSonicAdventure2AicaChannelSetupActiveBridgeTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaChannelSetupActiveTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaChannelSetupActiveTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C724, 0x8C15_C780)
                        && cpu.TryFastForwardSonicAdventure2AicaActiveChannelDescriptorAggregate(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaActiveChannelDescriptorAggregateSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaActiveChannelDescriptorAggregateSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C724, 0x8C15_C742)
                        ...
                        && cpu.TryFastForwardSonicAdventure2AicaZeroMaskDescriptorCopyHelperPrologue(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaZeroMaskDescriptorCopyHelperPrologueSkippedInstructions))
                    {
                        ...
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C696, 0x8C15_C69A)
                        && cpu.TryFastForwardSonicAdventure2AicaZeroMaskStatusUpdateCallBridge(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaZeroMaskStatusUpdateCallBridgeSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaZeroMaskStatusUpdateCallBridgeSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C5DC, 0x8C15_C620)
                        && cpu.TryFastForwardSonicAdventure2AicaStatusUpdateHelper(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaStatusUpdateSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaStatusUpdateSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C69C, 0x8C15_C714)
                        && cpu.TryFastForwardSonicAdventure2AicaZeroMaskNoEventEpilogue(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaZeroMaskNoEventEpilogueSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaZeroMaskNoEventEpilogueSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C622, 0x8C15_C680)
                        && cpu.TryFastForwardSonicAdventure2AicaDescriptorCopyHelper(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaDescriptorCopySkippedInstructions))
                    {
                        ...
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C666, 0x8C15_C680)
                        && cpu.TryFastForwardSonicAdventure2AicaDescriptorCopyInactiveBranchTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaDescriptorCopyInactiveTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaDescriptorCopyInactiveTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C744, 0x8C15_C77E)
                        && cpu.TryFastForwardSonicAdventure2AicaActiveChannelDescriptorTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaActiveChannelDescriptorTailSkippedInstructions))
                    {
                        ...
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C768, 0x8C15_C780)
                        && cpu.TryFastForwardSonicAdventure2AicaActiveChannelDescriptorMaskTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaActiveChannelDescriptorMaskTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaActiveChannelDescriptorMaskTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C780, 0x8C15_C856)
                        && cpu.TryFastForwardSonicAdventure2AicaInactiveChannelTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaInactiveChannelTailSkippedInstructions))
                    {
                        ...
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C574, 0x8C15_C680)
                        && cpu.TryFastForwardSonicAdventure2AicaZeroMaskDescriptorCopyCallBridge(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaZeroMaskDescriptorCopyCallBridgeSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaZeroMaskDescriptorCopyCallBridgeSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C56E, 0x8C15_C570)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C57C, 0x8C15_C5D8)
                        && cpu.TryFastForwardSonicAdventure2AicaActiveChannelPostSetupReturnAggregate(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaActiveChannelPostSetupReturnAggregateSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaActiveChannelPostSetupReturnAggregateSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C56E, 0x8C15_C570)
                        && cpu.TryFastForwardSonicAdventure2AicaActiveChannelReturnBridge(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaActiveChannelReturnBridgeSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaActiveChannelReturnBridgeSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_CA18, 0x8C15_CA32)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C0E2, 0x8C15_C11E)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C126, 0x8C15_C142)
                        && cpu.TryFastForwardSonicAdventure2AicaModeNineDescriptorUpdateWrapper(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaModeNineDescriptorUpdateSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaModeNineDescriptorUpdateSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_CA7A, 0x8C15_CA8E)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C0E2, 0x8C15_C11E)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C126, 0x8C15_C142)
                        && cpu.TryFastForwardSonicAdventure2AicaModeOneDescriptorUpdateWrapper(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaModeOneDescriptorUpdateSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaModeOneDescriptorUpdateSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_BEDA, 0x8C15_BF1C)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C0E2, 0x8C15_C11E)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C126, 0x8C15_C142)
                        && cpu.TryFastForwardSonicAdventure2AicaDescriptorUpdateNoEventAggregate(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaDescriptorUpdateAggregateSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaDescriptorUpdateAggregateSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_BEDA, 0x8C15_BF1C)
                        && cpu.TryFastForwardSonicAdventure2AicaDescriptorUpdatePrologue(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaDescriptorUpdatePrologueSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaDescriptorUpdatePrologueSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_BF1E, 0x8C15_BF72)
                        && cpu.TryFastForwardSonicAdventure2AicaDescriptorSetupToPointerAdvance(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaDescriptorSetupSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaDescriptorSetupSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_BF74, 0x8C15_BFC2)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_CE86, 0x8C15_CE8C)
                        && cpu.TryFastForwardSonicAdventure2AicaDescriptorPointerAndFirstWord(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaDescriptorPointerAndFirstWordSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaDescriptorPointerAndFirstWordSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_BFC4, 0x8C15_BFE4)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C038, 0x8C15_C08C)
                        && cpu.TryFastForwardSonicAdventure2AicaDescriptorSecondAndThirdWordTakenPath(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaDescriptorSecondAndThirdWordSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaDescriptorSecondAndThirdWordSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C08E, 0x8C15_C096)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C0E2, 0x8C15_C11E)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C126, 0x8C15_C142)
                        && cpu.TryFastForwardSonicAdventure2AicaDescriptorCounterUpdateAndReturn(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaDescriptorCounterReturnSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaDescriptorCounterReturnSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C418, 0x8C15_C46A)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C488, 0x8C15_C492)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C498, 0x8C15_C4C6)
                        && cpu.TryFastForwardSonicAdventure2AicaDescriptorHeadUpdate(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaDescriptorHeadUpdateSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaDescriptorHeadUpdateSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_CE5E, 0x8C15_CE70)
                        && cpu.TryFastForwardSonicAdventure2AicaDmaDescriptorCompleteMarker(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaDmaDescriptorCompleteMarkerSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaDmaDescriptorCompleteMarkerSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_CE72, 0x8C15_CE86)
                        && cpu.TryFastForwardSonicAdventure2AicaWordFillPositivePrologue(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaWordFillPositivePrologueSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWordFillPositivePrologueSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_CE7A, 0x8C15_CE86)
                        && cpu.TryFastForwardSonicAdventure2AicaWordFillLoop(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaWordFillLoopSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWordFillLoopSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_CE86, 0x8C15_CE8C)
                        && cpu.TryFastForwardSonicAdventure2AicaPointerMaskHelper(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaPointerMaskHelperSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaPointerMaskHelperSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C57E, 0x8C15_C5D8)
                        && cpu.TryFastForwardSonicAdventure2AicaPostSetupReturnAggregate(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaPostSetupReturnAggregateSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaPostSetupReturnAggregateSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        ...
                        && cpu.TryFastForwardSonicAdventure2AicaChannelFlagReturnTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaChannelFlagReturnTailSkippedInstructions))
                    {
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B938, 0x8C15_B940)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B8EC, 0x8C15_B918)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C416, 0x8C15_C4C6)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B918, 0x8C15_B92E)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C4DC, 0x8C15_C564)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C56E, 0x8C15_C570)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_C57C, 0x8C15_C5D8)
                        && cpu.TryFastForwardSonicAdventure2AicaNameLoopTailExitNextGroupTailAggregate(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaNameLoopTailExitGroupTailAggregateSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaNameLoopTailExitGroupTailAggregateSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B930, 0x8C15_B938)
                        ...
                        && cpu.TryFastForwardSonicAdventure2AicaNameLoopTailNextActiveSetupAggregate(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaNameLoopTailNextActiveSetupAggregateSkippedInstructions))
                    {
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B930, 0x8C15_B938)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B918, 0x8C15_B92E)
                        && cpu.TryFastForwardSonicAdventure2AicaNameLoopTailNextCallBridge(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaNameLoopTailNextCallBridgeSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaNameLoopTailNextCallBridgeSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B930, 0x8C15_B938)
                        ...
                        && cpu.TryFastForwardSonicAdventure2AicaWorkPollNoWorkInterrupt(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaWorkPollSkippedInstructions))
                    {
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_3A90, 0x8C15_3AE8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B4CC, 0x8C16_B5C8)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkPollInterruptRestoreTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaWorkPollInterruptRestoreTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkPollInterruptRestoreTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_3A90, 0x8C15_3AE8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B4CC, 0x8C16_B5C8)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkPollWorkGlobalLoadTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaWorkPollWorkGlobalLoadTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkPollWorkGlobalLoadTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_3A90, 0x8C15_3AE8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B4CC, 0x8C16_B5C8)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkPollStatusLoadTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaWorkPollStatusLoadTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkPollStatusLoadTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_3A90, 0x8C15_3AE8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B4CC, 0x8C16_B5C8)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkPollFinalSrLiteralTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaWorkPollFinalSrLiteralTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkPollFinalSrLiteralTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_3A90, 0x8C15_3AE8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B4CC, 0x8C16_B5C8)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkPollFinalSrRegisterTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaWorkPollFinalSrRegisterTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkPollFinalSrRegisterTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_3A90, 0x8C15_3AE8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B4CC, 0x8C16_B5C8)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkPollFinalSrRestoreTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaWorkPollFinalSrRestoreTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkPollFinalSrRestoreTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_3A90, 0x8C15_3AE8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B4CC, 0x8C16_B5C8)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkPollFinalSrLoadTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaWorkPollFinalSrLoadTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkPollFinalSrLoadTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_3A90, 0x8C15_3AE8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B4CC, 0x8C16_B5C8)
                        && cpu.TryFastForwardSonicAdventure2AicaWorkPollNoWorkInterruptCountTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaWorkPollCountTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaWorkPollCountTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C12_F7F4, 0x8C12_F802)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_3A90, 0x8C15_3AE8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C16_B4CC, 0x8C16_B5C8)
                        && cpu.TryFastForwardSonicAdventure2AicaOuterWorkPollLoopHead(
                            step,
                            scheduler.ClampFastForwardToExternalWake(options.InstructionLimit - cpu.State.InstructionsExecuted),
                            out var sonicAdventure2AicaOuterWorkPollHeadSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaOuterWorkPollHeadSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                            ...
                            out var sonicAdventure2AicaOuterWorkPollSkippedInstructions))
                    {
                        ...
                        && cpu.TryFastForwardSonicAdventure2G2DmaStatusClearLoopEntryTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaStatusClearEntryTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaStatusClearEntryTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B16A, 0x8C15_B178)
                        ...
                        && cpu.TryFastForwardSonicAdventure2G2DmaStatusClearFunction(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaStatusClearFunctionSkippedInstructions))
                    {
                        ...
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_09E2, 0x8C17_09FA)
                        && cpu.TryFastForwardSonicAdventure2G2DmaStatusClearHelperEntryTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaStatusClearHelperEntryTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaStatusClearHelperEntryTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_09E0, 0x8C17_09FA)
                        && cpu.TryFastForwardSonicAdventure2G2DmaStatusClearHelperTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaStatusClearTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaStatusClearTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_09E0, 0x8C17_09FA)
                        && cpu.TryFastForwardSonicAdventure2G2DmaStatusClearHelperPostShiftTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaStatusClearPostShiftTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaStatusClearPostShiftTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_09F8, 0x8C17_09FA)
                        && cpu.TryFastForwardSonicAdventure2G2DmaStatusClearHelperReturnDelaySlot(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaStatusClearReturnDelaySlotSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaStatusClearReturnDelaySlotSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        ...
                        && cpu.TryFastForwardSonicAdventure2G2DmaStatusSetHelper(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaStatusSetSkippedInstructions))
                    {
                        ...
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0A98, 0x8C17_0AE0)
                        && cpu.TryFastForwardSonicAdventure2G2DmaStatusSetHelperMaskTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaStatusSetMaskTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaStatusSetMaskTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0A98, 0x8C17_0AE0)
                        && cpu.TryFastForwardSonicAdventure2G2DmaStatusSetHelperTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaStatusSetTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaStatusSetTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0A98, 0x8C17_0AE0)
                        && cpu.TryFastForwardSonicAdventure2G2DmaStatusSetHelperStatusReadTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaStatusSetStatusReadTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaStatusSetStatusReadTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0A98, 0x8C17_0AE0)
                        && cpu.TryFastForwardSonicAdventure2G2DmaStatusSetHelperIndexTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaStatusSetIndexTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaStatusSetIndexTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0A98, 0x8C17_0AE0)
                        && cpu.TryFastForwardSonicAdventure2G2DmaStatusSetHelperStatusMoveTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaStatusSetStatusMoveTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaStatusSetStatusMoveTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0A98, 0x8C17_0AE0)
                        && cpu.TryFastForwardSonicAdventure2G2DmaStatusSetHelperStatusWriteTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaStatusSetStatusWriteTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaStatusSetStatusWriteTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0A98, 0x8C17_0AE0)
                        && cpu.TryFastForwardSonicAdventure2G2DmaStatusSetHelperSrLiteralTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaStatusSetSrLiteralTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaStatusSetSrLiteralTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0A98, 0x8C17_0AE0)
                        && cpu.TryFastForwardSonicAdventure2G2DmaStatusSetHelperSrRestoreTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaStatusSetSrRestoreTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaStatusSetSrRestoreTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B200, 0x8C15_B234)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0A98, 0x8C17_0AE0)
                        && cpu.TryFastForwardSonicAdventure2G2DmaStatusSetFunctionLoop(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaStatusSetFunctionLoopSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaStatusSetFunctionLoopSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B200, 0x8C15_B234)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0A98, 0x8C17_0AE0)
                        && cpu.TryFastForwardSonicAdventure2G2DmaStatusSetCallTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaStatusSetCallTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaStatusSetCallTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B200, 0x8C15_B234)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0A98, 0x8C17_0AE0)
                        && cpu.TryFastForwardSonicAdventure2G2DmaStatusSetFunctionRestoreTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaStatusSetFunctionRestoreTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaStatusSetFunctionRestoreTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B200, 0x8C15_B234)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0A98, 0x8C17_0AE0)
                        && cpu.TryFastForwardSonicAdventure2G2DmaStatusSetLoopTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaStatusSetLoopTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaStatusSetLoopTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B200, 0x8C15_B234)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0A98, 0x8C17_0AE0)
                        && cpu.TryFastForwardSonicAdventure2G2DmaStatusSetLoopBranchTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaStatusSetLoopBranchTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaStatusSetLoopBranchTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B200, 0x8C15_B234)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0A98, 0x8C17_0AE0)
                        && cpu.TryFastForwardSonicAdventure2G2DmaStatusSetLoop(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaStatusSetLoopSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaStatusSetLoopSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        ...
                        && cpu.TryFastForwardSonicAdventure2AicaExecutionWaitLoop(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaExecutionSkippedInstructions))
                    {
                        ...
                        && cpu.TryFastForwardSonicAdventure2AicaReadWordWrapperEntryTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaReadWordEntryTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaReadWordEntryTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_56D8, 0x8C13_5838)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0A98, 0x8C17_0AD8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0BBC, 0x8C17_0BDC)
                        && cpu.TryFastForwardSonicAdventure2AicaReadWordWrapperCallDelaySlot(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaReadWordCallDelaySlotSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaReadWordCallDelaySlotSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_56D8, 0x8C13_5838)
                        ...
                        && cpu.TryFastForwardSonicAdventure2AicaReadWordWrapper(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaReadWordSkippedInstructions))
                    {
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_56D8, 0x8C13_5838)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_43A0, 0x8C15_43DE)
                        && cpu.TryFastForwardSonicAdventure2AicaReadWordWrapperR13StoreTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaReadWordR13StoreTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaReadWordR13StoreTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_56D8, 0x8C13_5838)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_43A0, 0x8C15_43DE)
                        && cpu.TryFastForwardSonicAdventure2AicaReadWordWrapperTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaReadWordTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaReadWordTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_56D8, 0x8C13_5838)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_43C8, 0x8C15_43DE)
                        && cpu.TryFastForwardSonicAdventure2AicaReadWordWrapperValidRangeBridge(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaReadWordValidRangeBridgeSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaReadWordValidRangeBridgeSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_56D8, 0x8C13_5838)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_43C8, 0x8C15_43DE)
                        && cpu.TryFastForwardSonicAdventure2AicaReadWordWrapperCallTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaReadWordCallTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaReadWordCallTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_43D4, 0x8C15_43DE)
                        ...
                        && cpu.TryFastForwardSonicAdventure2AicaReadWordWrapperR12MoveTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaReadWordR12MoveTailSkippedInstructions))
                    {
                        ...
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_43DC, 0x8C15_43DE)
                        && cpu.TryFastForwardSonicAdventure2AicaReadWordWrapperReturnDelaySlot(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaReadWordReturnDelaySlotSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaReadWordReturnDelaySlotSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_575E, 0x8C13_5838)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_AF98, 0x8C15_AFCA)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B158, 0x8C15_B18A)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_08B4, 0x8C17_08D4)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_09E0, 0x8C17_09FA)
                        && cpu.TryFastForwardSonicAdventure2G2PioReadWordPostStatusSetTail(
                            step,
                            options.InstructionLimit - cpu.State.InstructionsExecuted,
                            out var sonicAdventure2G2PioReadWordPostStatusSetTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2PioReadWordPostStatusSetTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_576C, 0x8C13_5838)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_AF98, 0x8C15_AFCA)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B158, 0x8C15_B18A)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_08B4, 0x8C17_08D4)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_09E0, 0x8C17_09FA)
                        && cpu.TryFastForwardSonicAdventure2G2PioReadWordStatusProbeCallTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2PioReadWordStatusProbeCallTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2PioReadWordStatusProbeCallTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_575E, 0x8C13_5838)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_08B4, 0x8C17_08D4)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_09E0, 0x8C17_09FA)
                        && cpu.TryFastForwardSonicAdventure2G2PioReadWordMode4DispatchTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2PioReadWordMode4DispatchTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2PioReadWordMode4DispatchTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_575E, 0x8C13_5838)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_08B4, 0x8C17_08D4)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_09E0, 0x8C17_09FA)
                        && cpu.TryFastForwardSonicAdventure2G2PioReadWordMode4BranchTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2PioReadWordMode4BranchTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2PioReadWordMode4BranchTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_5BC0, 0x8C13_5C16)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_AF98, 0x8C15_AFCA)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B244, 0x8C15_B262)
                        && cpu.TryFastForwardSonicAdventure2G2PioWriteLoopEntryTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2PioWriteEntrySkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2PioWriteEntrySkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                    ...
                    else if (CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C10_F8D8, 0x8C10_F8E8)
                        && cpu.TryFastForwardSonicAdventure2CacheWritebackLoop(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2CacheWritebackSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2CacheWritebackSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        ...
                        && cpu.TryFastForwardSonicAdventure2InterruptCallbackEmptyScanTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2InterruptCallbackScanSkippedInstructions))
                    {
                        ...
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C10_FE50, 0x8C10_FE68)
                        && cpu.TryFastForwardSonicAdventure2InterruptCallbackListDispatchPrologue(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2InterruptCallbackListDispatchPrologueSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2InterruptCallbackListDispatchPrologueSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C10_FEE4, 0x8C10_FF20)
                        && cpu.TryFastForwardSonicAdventure2InterruptSourceDecodeIrqbPrologue(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2InterruptSourceDecodeIrqbPrologueSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2InterruptSourceDecodeIrqbPrologueSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C10_FF22, 0x8C10_FF42)
                        && cpu.TryFastForwardSonicAdventure2InterruptSourceFirstIrqbDispatchPrefix(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2InterruptSourceFirstIrqbDispatchPrefixSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2InterruptSourceFirstIrqbDispatchPrefixSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C10_FE72, 0x8C10_FE98)
                        && cpu.TryFastForwardSonicAdventure2SrCallbackListDispatchPrologue(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2SrCallbackListDispatchPrologueSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2SrCallbackListDispatchPrologueSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C10_FE72, 0x8C10_FE98)
                        && cpu.TryFastForwardSonicAdventure2SrCallbackListExitTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2SrCallbackListExitSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2SrCallbackListExitSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C10_FE72, 0x8C10_FE98)
                        && cpu.TryFastForwardSonicAdventure2SrCallbackListNextActiveTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2SrCallbackListNextActiveSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2SrCallbackListNextActiveSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C14_C862, 0x8C14_CB80)
                        && cpu.TryFastForwardSonicAdventure2InterruptCallbackStatusQuietPath(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2InterruptCallbackStatusQuietPathSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2InterruptCallbackStatusQuietPathSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C14_C8AC, 0x8C14_CB80)
                        && cpu.TryFastForwardSonicAdventure2InterruptCallbackStatusQuietTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2InterruptCallbackStatusQuietTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2InterruptCallbackStatusQuietTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C14_CB82, 0x8C14_CBBC)
                        && cpu.TryFastForwardSonicAdventure2InterruptCallbackStatusReturnTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2InterruptCallbackStatusReturnSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2InterruptCallbackStatusReturnSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C14_CED4, 0x8C14_D154)
                        && cpu.TryFastForwardSonicAdventure2InterruptCallbackStatusDecoderPrefix(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2InterruptCallbackStatusDecoderSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2InterruptCallbackStatusDecoderSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C14_D1F6, 0x8C14_D22C)
                        && cpu.TryFastForwardSonicAdventure2InterruptCallbackFpuWrapperPrologue(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2InterruptCallbackFpuWrapperSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2InterruptCallbackFpuWrapperSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C14_D212, 0x8C14_D22C)
                        && cpu.TryFastForwardSonicAdventure2InterruptCallbackFpuWrapperSavedRegisterTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2InterruptCallbackFpuWrapperSavedTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2InterruptCallbackFpuWrapperSavedTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C14_C9BA, 0x8C14_CB80)
                        && cpu.TryFastForwardSonicAdventure2InterruptCallbackStatusInactiveTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2InterruptCallbackStatusInactiveSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2InterruptCallbackStatusInactiveSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_3BB4, 0x8C15_3C02)
                        && cpu.TryFastForwardSonicAdventure2AicaMemoryBlockHeaderProbe(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaMemoryBlockHeaderProbeSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaMemoryBlockHeaderProbeSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_3C24, 0x8C15_3C64)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_3BB4, 0x8C15_3C02)
                        && cpu.TryFastForwardSonicAdventure2AicaMemoryBlockDescriptorMark(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaMemoryBlockDescriptorMarkSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaMemoryBlockDescriptorMarkSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_5688, 0x8C13_56D0)
                        && cpu.TryFastForwardSonicAdventure2G2DmaInactiveStatusProbe(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaInactiveStatusProbeSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaInactiveStatusProbeSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B24E, 0x8C15_B276)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0BBC, 0x8C17_0BCA)
                        && cpu.TryFastForwardSonicAdventure2G2DmaInactiveStatusProbeWrapperTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaInactiveStatusProbeWrapperTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaInactiveStatusProbeWrapperTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B258, 0x8C15_B276)
                        && cpu.TryFastForwardSonicAdventure2G2DmaInactiveStatusProbeWrapperBranchTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaInactiveStatusProbeWrapperBranchTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaInactiveStatusProbeWrapperBranchTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B260, 0x8C15_B276)
                        && cpu.TryFastForwardSonicAdventure2G2DmaInactiveStatusProbeWrapperCounterTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaInactiveStatusProbeWrapperCounterTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaInactiveStatusProbeWrapperCounterTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B268, 0x8C15_B276)
                        && cpu.TryFastForwardSonicAdventure2G2DmaInactiveStatusProbeWrapperReturnTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2DmaInactiveStatusProbeWrapperReturnTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2DmaInactiveStatusProbeWrapperReturnTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_AF98, 0x8C15_AFCA)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_08B8, 0x8C17_08D4)
                        && cpu.TryFastForwardSonicAdventure2AicaRegisterPairStatusProbeWrapperProbeBodyTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaRegisterPairStatusProbeWrapperProbeBodyTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaRegisterPairStatusProbeWrapperProbeBodyTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_AF98, 0x8C15_AFCA)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_08B4, 0x8C17_08D4)
                        && cpu.TryFastForwardSonicAdventure2AicaRegisterPairStatusProbeWrapperReturnTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaRegisterPairStatusProbeWrapperReturnTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaRegisterPairStatusProbeWrapperReturnTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_AF98, 0x8C15_AFCA)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_08B4, 0x8C17_08D4)
                        && cpu.TryFastForwardSonicAdventure2AicaRegisterPairStatusProbeWrapperZeroReturnTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaRegisterPairStatusProbeWrapperZeroReturnTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaRegisterPairStatusProbeWrapperZeroReturnTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_AF98, 0x8C15_AFCA)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_08B4, 0x8C17_08D4)
                        && cpu.TryFastForwardSonicAdventure2AicaRegisterPairStatusProbeWrapperEpilogueTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaRegisterPairStatusProbeWrapperEpilogueTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaRegisterPairStatusProbeWrapperEpilogueTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C11_05F0, 0x8C11_061A)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C11_0906, 0x8C11_097C)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0A98, 0x8C17_0AD8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0BBC, 0x8C17_0BDC)
                        && cpu.TryFastForwardSonicAdventure2AicaRegisterPairPollWrapper(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaRegisterPairPollSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaRegisterPairPollSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C11_0906, 0x8C11_097C)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0A98, 0x8C17_0AD8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0BBC, 0x8C17_0BDC)
                        && cpu.TryFastForwardSonicAdventure2AicaStableRegisterPairReadHelper(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaStableRegisterPairReadSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaStableRegisterPairReadSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        ...
                        && cpu.TryFastForwardSonicAdventure2AicaRegisterPairReadPointerLoop(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaRegisterPairReadPointerLoopSkippedInstructions))
                    {
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0A98, 0x8C17_0AD8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0BBC, 0x8C17_0BDC)
                        && cpu.TryFastForwardSonicAdventure2AicaRegisterPairReadWrapper(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2AicaRegisterPairReadSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2AicaRegisterPairReadSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_56DA, 0x8C13_5838)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_AF98, 0x8C15_AFCA)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B158, 0x8C15_B18A)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B200, 0x8C15_B234)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B244, 0x8C15_B262)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0A98, 0x8C17_0AD8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0BBC, 0x8C17_0BDC)
                        && cpu.TryFastForwardSonicAdventure2G2PioReadHelperPrologue(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2PioReadPrologueSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2PioReadPrologueSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_56DE, 0x8C13_5838)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_AF98, 0x8C15_AFCA)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B158, 0x8C15_B18A)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B200, 0x8C15_B234)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B244, 0x8C15_B262)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0A98, 0x8C17_0AD8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0BBC, 0x8C17_0BDC)
                        && cpu.TryFastForwardSonicAdventure2G2PioReadHelperMidPrologue(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2PioReadMidPrologueSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2PioReadMidPrologueSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_56D8, 0x8C13_5838)
                        ...
                        && cpu.TryFastForwardSonicAdventure2G2PioExternalReadHelper(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2PioExternalReadSkippedInstructions))
                    {
                        ...
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_56E8, 0x8C13_5838)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_AF98, 0x8C15_AFCA)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B158, 0x8C15_B18A)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B200, 0x8C15_B234)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B244, 0x8C15_B262)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0A98, 0x8C17_0AD8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0BBC, 0x8C17_0BDC)
                        && cpu.TryFastForwardSonicAdventure2G2PioReadWordHelperLocalFrameTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2PioReadLocalFrameTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2PioReadLocalFrameTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_570E, 0x8C13_5838)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_AF98, 0x8C15_AFCA)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B158, 0x8C15_B18A)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B200, 0x8C15_B234)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C15_B244, 0x8C15_B262)
                        ...
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0A98, 0x8C17_0AD8)
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C17_0BBC, 0x8C17_0BDC)
                        && cpu.TryFastForwardSonicAdventure2G2PioReadWordHelperInterruptRestoreTail(step, options.InstructionLimit - cpu.State.InstructionsExecuted, out var sonicAdventure2G2PioReadInterruptRestoreTailSkippedInstructions))
                    {
                        scheduler.AdvanceAfterCpuFastForward(sonicAdventure2G2PioReadInterruptRestoreTailSkippedInstructions, cpu.State.InstructionsExecuted);
                    }
                    else if (options.MemoryReadWatch is null
                        && options.MemoryWriteWatch is null
                        && CanFastForwardTraceRange(options.TraceCapture, traceLog, 0x8C13_56D8, 0x8C13_5838)
