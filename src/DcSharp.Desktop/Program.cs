...
internal sealed class MainForm : Form
{
    ...
    private static string BuildSummary(DreamcastRunResult result, DreamcastRunSummary summary, TimeSpan elapsed)
    {
        var lines = new List<string>
        {
            ...
            $"AICA: registers={summary.Audio.RegisterAccessCount:N0}, channels={summary.Audio.Channels.Count:N0}, active={summary.Audio.ActiveChannelCount:N0}, mailbox={summary.Audio.CommandQueueActivityCount:N0}",
