...
internal sealed class MainForm : Form
{
    ...
    private static string BuildSummary(DreamcastRunResult result, DreamcastRunSummary summary, TimeSpan elapsed)
    {
        var lines = new List<string>
        {
            ...
            $"AICA: registers={summary.Audio.RegisterAccessCount:N0}, channels={summary.Audio.Channels.Count:N0}, active={summary.Audio.ActiveChannelCount:N0}, mailbox={summary.Audio.CommandQueueActivityCount:N0}, queues={summary.Audio.CommandQueues.Count:N0} (cmd={summary.Audio.CommandQueues.Count(queue => queue.Role == "Command"):N0}, resp={summary.Audio.CommandQueues.Count(queue => queue.Role == "Response"):N0}), text={summary.Audio.TextMarkers.Count:N0}",
